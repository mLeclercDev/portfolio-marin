...
const Testimonial = ({testimonial}) => {
    ...
    useEffect(() => {
        ...
        const timer = setTimeout(() => {
          const linesSecond = textRef.current.querySelectorAll(".testimonial .line");
          console.log("lines : ", linesSecond);
      
          timeline.to(linesSecond, { y: "0%", rotate: 0, ease: "hyperBounce", duration: 1 });
        }, 555);
            ...
            <div className='container'>
                <div className='quotes-icon'>
                    <svg width="162" height="179" viewBox="0 0 162 179" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M88 94.27H162L122.73 139L88 178.27V94.27Z" fill="#110F09"/>
                ...
                <div className='testimonial-content'>
                    ...
                    <a href={`${testimonial[0].linkedin}`} target="_blank" className='arrow-link cs-scale'>
                        <span>
                        {testimonial[0].client}
                        </span>
                        <div className='arrow'>
